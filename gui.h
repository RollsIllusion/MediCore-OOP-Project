...
public:
    ...
    // Rule of Three: required because ~ScrollableList deletes heap arrays.
    // Without these the compiler-generated copy shallow-copies rows_ and
    // double-frees when the temporary in list_ = ScrollableList(...) dies.
    ScrollableList(const ScrollableList& o);
    ScrollableList& operator=(const ScrollableList& o);
